# Portfolio Analytics (v. React)

A python hook to interact with Diligence Vault using their API and python requests

The hook can
* Get a Token to interact with DV
* List Firms
* List Products
* List Projects
* Download Projects (as a zip file - DVs way not my ideal way)
* Ge
